...
import 'package:quizappuic/features/quiz/models/answerOption.dart';
...
import 'package:quizappuic/ui/widgets/optionContainer.dart';
import 'package:quizappuic/ui/widgets/questionBackgroundCard.dart';
import 'package:quizappuic/ui/widgets/settingsDialogContainer.dart';
import 'package:quizappuic/utils/constants.dart';
import 'package:quizappuic/utils/lifeLineOptions.dart';
...
class _QuestionsContainerState extends State<QuestionsContainer> {
  ...
  Widget _buildCurrentQuestionIndex() {
    return Align(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.only(
            start: widget.lifeLines.isEmpty
                ? 0
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.only(
                            end: widget.bookmarkButton.toString() == "Container"
                                ? 0.0
                                : 30.0),
                        child: IconButton(
