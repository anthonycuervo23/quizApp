...
import 'package:quizappuic/features/auth/authLocalDataSource.dart';
import 'package:quizappuic/features/auth/authRemoteDataSource.dart';
...
class AuthRepository {
  ...
  getLocalAuthDetails() {
    return {
      ...
      "authProvider":
          getAuthProviderFromString(_authLocalDataSource.getAuthType()),
    };
  }
  ...
  Future<Map<String, dynamic>> signInUser(
    ...
    try {
      final result = await _authRemoteDataSource.signInUser(authProvider,
