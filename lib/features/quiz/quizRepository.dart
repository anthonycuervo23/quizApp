...
import 'package:quizappuic/features/quiz/models/leaderBoardMonthly.dart';
import 'package:quizappuic/features/quiz/quizException.dart';
import 'package:quizappuic/features/quiz/quizRemoteDataSoure.dart';
...
class QuizRepository {
  ...
  Future<List<GuessTheWordQuestion>> getGuessTheWordQuestions(
    ...
    try {
      final result =
          await _quizRemoteDataSource.getGuessTheWordQuestions(languageId);
      return result
  ...
  Future getComprehension() async {
    try {
      ...
      List result =
          await _quizRemoteDataSource.getComprehension() /*as Future<dynamic>*/;
