import 'package:quizappuic/features/profileManagement/profileManagementException.dart';
import 'package:quizappuic/features/profileManagement/profileManagementLocalDataSource.dart';
import 'package:quizappuic/features/profileManagement/profileManagementRemoteDataSource.dart';
  ...
  Future<Map> updateScore(
    ...
    try {
      final result = await _profileManagementRemoteDataSource.updateScore(
          userId: userId, score: score.toString());
      return Map.from(result);
    } catch (e) {
      throw ProfileManagementException(errorMessageCode: e.toString());
    }
