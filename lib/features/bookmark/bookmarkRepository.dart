import 'package:quizappuic/features/bookmark/bookmarkException.dart';
import 'package:quizappuic/features/bookmark/bookmarkLocalDataSource.dart';
import 'package:quizappuic/features/bookmark/bookmarkRemoteDataSource.dart';
...
class BookmarkRepository {
  ...
  Future<List<String>> getSubmittedAnswerOfBookmarkedQuestions(
    ...
    return _bookmarkLocalDataSource
        .getAnswerOfBookmarkedQuestion(questions.map((e) => e.id).toList());
  }
